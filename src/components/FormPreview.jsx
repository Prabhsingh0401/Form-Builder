  ...
  return (
    <div className={`${containerClass} border-l p-4 overflow-x-auto scrollbar-hide ${
      ...
      <div className="flex justify-center">
        ...
        >
          {/* Decorative elements */}
          <div className="absolute -top-24 -right-24 w-48 h-48 rounded-full bg-gradient-to-br from-purple-500/10 to-pink-500/10 blur-xl"></div>
          <div className="absolute -bottom-24 -left-24 w-48 h-48 rounded-full bg-gradient-to-tr from-blue-500/10 to-cyan-500/10 blur-xl"></div>
          ...
          <div className="relative">
            ...
            {form.fields.length === 0 ? (
              <div className={`text-center py-12 rounded-lg border-2 border-dashed ${
                ...
                <div className="w-16 h-16 mx-auto mb-4 rounded-full flex items-center justify-center bg-gradient-to-br from-purple-500/20 to-pink-500/20">
              ...
              <div className="space-y-6">
                {form.fields.map((field) => (
                  <div key={field.id} className="group">
                    ...
                    <FormFieldPreview field={field} darkMode={darkMode} />
                    {field.helpText && (
